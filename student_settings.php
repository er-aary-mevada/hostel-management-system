    ...
    <div class="dashboard-container">
        ...
        <div class="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <a href="student_rooms.php" class="nav-item">
                    <i class="fas fa-bed"></i>
                    <span>View Rooms</span>
                </a>
                <a href="student_payment.php" class="nav-item">
                    <i class="fas fa-credit-card"></i>
                    <span>My Payments</span>
                </a>
                <a href="student_settings.php" class="nav-item active">
        ...
        <div class="main-content">
            ...
            <div class="settings-container">
                ...
                <div class="settings-section">
                    ...
                    <div class="room-info">
                        <p>Room information will be available when the student database structure is properly set up.</p>
                        <a href="rooms.php" class="btn">Browse Available Rooms</a>
                    </div>
                </div>
            </div>
        </div>
